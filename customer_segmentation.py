...
cd /gdrive/MyDrive/Customer_Segmentation
...
Ever_Married_numeric = {'No':1,'Yes':0}
df_train.Ever_Married.replace(Ever_Married_numeric, inplace=True)

Gender_numeric = {'Male':1,'Female':0}
df_train.Gender.replace(Gender_numeric, inplace=True)

Graduated_numeric = {'No':1,'Yes':0}
df_train.Graduated.replace(Graduated_numeric, inplace=True)

Profession_numeric = {'Homemaker':8,'Marketing':7,'Executive':6,'Lawyer':5,'Doctor':4,'Engineer':3,'Entertainment':2,'Healthcare':1,'Artist':0}
df_train.Profession.replace(Profession_numeric, inplace=True)

Spending_Score_numeric = {'High':2,'Average':1,'Low':0}
df_train.Spending_Score.replace(Spending_Score_numeric, inplace=True)

Var_1_numeric = {'Cat_7':6,'Cat_6':5,'Cat_5':4,'Cat_4':3,'Cat_3':2,'Cat_2':1,'Cat_1':0}
df_train.Var_1.replace(Var_1_numeric, inplace=True)

df_train['Ever_Married'].fillna(value =df_train['Ever_Married'].mean() , inplace = True)
df_train['Graduated'].fillna(value =df_train['Graduated'].mean() , inplace = True)
df_train['Profession'].fillna(value =df_train['Profession'].mean() , inplace = True)
df_train['Work_Experience'].fillna(value =df_train['Work_Experience'].mean() , inplace = True)
df_train['Family_Size'].fillna(value =df_train['Family_Size'].mean() , inplace = True)
df_train['Var_1'].fillna(value =df_train['Var_1'].mean() , inplace = True)

sns.countplot("Family_Size", data=df_train)

sns.countplot("Graduated", data=df_train)
